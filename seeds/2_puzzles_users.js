  ...
  return knex('puzzles_users').del()
    .then(() => {
      return knex('puzzles_users').insert([
        ...
        { puzzle_id: 3, user_id: 1, puzzle_solving_time: 669 },
        { puzzle_id: 3, user_id: 2, puzzle_solving_time: 661 },
        { puzzle_id: 3, user_id: 3, puzzle_solving_time: 666 },
        { puzzle_id: 3, user_id: 4, puzzle_solving_time: 662 }
      ]);
    })
    .then(() => {
      return knex.raw(
